...
aws cloudformation update-stack --region us-east-2 --stack-name IMLP-Sandbox-Web-App --template-body file://../templates/imlp-web-app.yaml --capabilities CAPABILITY_IAM --no-verify-ssl \
--parameters \
